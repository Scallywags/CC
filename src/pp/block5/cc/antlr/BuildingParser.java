// Generated from Building.g4 by ANTLR 4.4
...
public class BuildingParser extends Parser {
	...
	public final FloorContext floor() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(13); match(FLOOR);
			setState(22);
			_la = _input.LA(1);
			if (_la==LSQ) {
				{
				setState(14); match(LSQ);
				setState(16); 
				_errHandler.sync(this);
				_la = _input.LA(1);
				do {
